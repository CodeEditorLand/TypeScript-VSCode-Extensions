...
var LZString = (() => {
	...
	var r = String.fromCharCode,
		...
		i = {
			compressToBase64: (o) => {
				if (o == null) return "";
				var r = i._compress(o, 6, (o) => n.charAt(o));
				switch (r.length % 4) {
					default:
					case 0:
						return r;
			...
			decompressFromBase64: (r) =>
				r == null
					...
					: r == ""
						? null
						: i._decompress(r.length, 32, (e) => o(n, r.charAt(e))),
			compressToUTF16: (o) =>
				o == null ? "" : i._compress(o, 15, (o) => r(o + 32)) + " ",
			...
			decompressFromUint8Array: (o) => {
				if (o === null || void 0 === o) return i.decompress(o);
				for (
			...
			compressToEncodedURIComponent: (o) =>
				o == null ? "" : i._compress(o, 6, (o) => e.charAt(o)),
			...
			_compress: (o, r, n) => {
				...
				if (a !== "") {
					if (Object.prototype.hasOwnProperty.call(p, a)) {
						...
						l--, l == 0 && ((l = Math.pow(2, h)), h++), delete p[a];
					} else
						for (t = s[a], e = 0; h > e; e++)
							(m = (m << 1) | (1 & t)),
								v == r - 1
			...
			_decompress: (o, n, e) => {
				...
				for (f[3] = l, s = l, w.push(l); ; ) {
					...
					if ((h == 0 && ((h = Math.pow(2, m)), m++), f[l])) v = f[l];
					else {
						if (l !== d) return null;
						v = s + s.charAt(0);
					}
